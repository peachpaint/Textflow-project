...
const works = [
  ...
  },
  {
    ...
    title: '미스터리 탐정',
    episode: 'EP. 21',
    image: 'https://images.unsplash.com/photo-1698956483970-a47edef29331?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxteXN0ZXJ5JTIwdGhyaWxsZXIlMjBib29rfGVufDF8fHx8MTc2NDY5NjkzN3ww&ixlib=rb-4.1.0&q=80&w=1080',
    genre: '스릴러',
    isNew: true,
  },
  {
    ...
    title: '환생한 용사',
    episode: 'EP. 56',
    image: 'https://images.unsplash.com/photo-1653723367970-ae966c1b803e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhbmltZSUyMHN0eWxlJTIwaWxsdXN0cmF0aW9ufGVufDF8fHx8MTc2NDc1MzgyM3ww&ixlib=rb-4.1.0&q=80&w=1080',
    genre: '판타지',
    isNew: false,
  },
  {
    ...
    title: '운명의 만남',
    episode: 'EP. 12',
    image: 'https://images.unsplash.com/photo-1759863738666-7584248cdf7e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjb21pYyUyMGJvb2slMjBpbGx1c3RyYXRpb258ZW58MXx8fHwxNzY0ODE5ODQxfDA&ixlib=rb-4.1.0&q=80&w=1080',
    genre: '로맨스',
    isNew: true,
  },
];
